...
export default function Footer(props) {
    return (
        <div className={`${props.className ?? ''} bg-white space-y-4 col-span-5 px-5 py-7 grid grid-cols-4 text-gray-900`}>
            <div className="flex flex-col space-y-2 text-sm col-span-5 md:col-span-2 pr-3">
            ...
            <div className="flex flex-col md:col-span-1 col-span-5 space-y-2 text-sm">
